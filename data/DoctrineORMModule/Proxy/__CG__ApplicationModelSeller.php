 ...
 */
class Seller extends \Application\Model\Seller implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'vehicles', 'id', 'name', 'type', 'address', 'phone', 'email', 'website'];
        }
